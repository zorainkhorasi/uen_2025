...
@section('title',  trans('lang.hfa_app_users_main_heading')  )
...
@section('breadcrumb-title')
    <h3>{{ trans('lang.hfa_app_users_main_heading') }}</h3>
@endsection

@section('breadcrumb-items')
    <li class="breadcrumb-item active">{{ trans('lang.hfa_app_users_main_heading') }}</li>
@endsection
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-header project-list">
                        <h5>{{ trans('lang.hfa_app_users_dt_heading') }}</h5>
                        <span>{{ trans('lang.hfa_app_users_dt_paragraph') }}</span>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content ">
                                    ...
                                    <div class="modal-header bg-primary white">
                                        <h4 class="modal-title white" id="myModalLabel_add">Add User (hfa)</h4>
                            ...
                            <div class="modal fade text-left" id="editModal" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content ">
                                        ...
                                        <div class="modal-header bg-primary white">
                                            <h4 class="modal-title white" id="myModalLabel_edit">Edit User (hfa)</h4>
...
@section('script')
    ...
    <script>
        ...
        function addData() {
            ...
            if (flag == 0) {
                showloader();
                CallAjax('{{ url('/hfa_app_users/addAppUsers') }}', data, 'POST', function (result) {
                    hideloader();
        ...
        function getEdit(obj) {
            ...
            if (data['id'] != '' && data['id'] != undefined) {
                CallAjax('{{ url('/hfa_app_users/detail/') }}', data, 'GET', function (result) {
                    if (result != '' && JSON.parse(result).length > 0) {
        ...
        function editData() {
            ...
            if (flag === 0) {
                showloader();
                CallAjax('{{ url('/hfa_app_users/editAppUsers') }}', data, 'POST', function (result) {
                    hideloader();
                    if (result !== '' && JSON.parse(result).length > 0) {
                        var response = JSON.parse(result);
                        try {
        ...
        function deleteData() {
            ...
            if (data['id'] == '' || data['id'] == undefined) {
                ...
                showloader();
                CallAjax('{{ url('/hfa_app_users/deleteAppUsers') }}', data, 'POST', function (result) {
                    hideloader();
                    if (result !== '' && JSON.parse(result).length > 0) {
                        var response = JSON.parse(result);
                        try {
        ...
        function resetPwd() {
            ...
            if (flag === 0) {
                showloader();
                CallAjax('{{ url('/hfa_app_users/resetPwd') }}', data, 'POST', function (result) {
                    hideloader();
                    if (result !== '' && JSON.parse(result).length > 0) {
                        var response = JSON.parse(result);
                        try {
