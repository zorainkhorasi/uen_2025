                                        ...
                                        <a  href="{{route('hfa_summary_detail_table')}}/{{$keys}}" target="_blank">
                                            ...
                                            <div class="progress" style="height: 10px">
                                                <div class="progress-bar-animated mysmall_text bg-{{$colors[$s]}}"
                                                     role="progressbar"
                                                     style="width: 100%"
                                                     aria-valuenow="{{$total['tot']['count']}}" aria-valuemin="0"
                        ...
                        <div class="apex-chart-container goal-status text-center row">
                            ...
                            @if (isset($data['total']) && $data['total'] != '')
                                @foreach ($data['total'] as $keys=>$r)
                                    @php
                                        $s++;
                                         $t=(isset($r['tot']['count']) && $r['tot']['count']!=''?$r['tot']['count']:'0');
                                        $d=(isset($r['dc']['total']) && $r['dc']['total']!=''?$r['dc']['total']:'0');
                                        $perc_cal = ($d / $t) * 100;
                                        ...
                                        <a href="javascript:void(0)">
                                            ...
                                            <div class="progress" style="height: 10px">
                                                <div class="progress-bar-animated mysmall_text bg-{{$colors[$s]}}"
                                                     ...
                                                     aria-valuenow="{{$r['dc']['total']}}" aria-valuemin="0"
