...
use App\Models\LHW\HFC_Summary_Model;
...
class HFC_Summary extends Controller
{
    ...
    public function index()
    {
        ...
        /*==========Log=============*/
        $trackarray = array(
            "activityName" => "HFC_Summary",
            "action" => "View HFC Summary -> Function: HFC_Summary/index()",
            "PostData" => "",
            "affectedKey" => "",
            "idUser" => Auth::user()->id,
