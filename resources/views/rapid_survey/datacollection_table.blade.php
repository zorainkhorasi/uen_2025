                        ...
                        <div class="table-responsive2">
                            <table class="display datatables table-striped table-hover" id="datatable_custom">
                                ...
                                <tr>
                                    ...
                                    <th width="9%">HH Visited/Collected
                                    <th width="9%">HH Not Visited/Collected</th>
                                    <th width="9%">Completed</th>
                                    <th width="9%">Not Completed</th>
                                ...
                                @if (isset($data['get_dc_table']) && $data['get_dc_table'] != '')
                                    @foreach ($data['get_dc_table'] as $k=>$r)
                                        ...
                                        <tr>
                                            ...
                                            <td width="9%"><a href="{{route('rs_randomized_detail').'/'.$cluster_no}}"
                                                              target="_blank">{{isset($r['hh_randomized']) && $r['hh_randomized']!=''?$r['hh_randomized']:'0'}}</a>
                                            </td>
                                            <td width="9%"><a
                                                    href="{{route('rs_data_collection_statusdetail').'/t/'.$cluster_no}}"
                                                    target="_blank">{{isset($r['hh_collected']) && $r['hh_collected']!=''?$r['hh_collected']:'0'}}</a>
                                            </td>
                                            <td width="9%"><a
                                                    href="{{route('not_visit_detail').'/t/'.$cluster_no}}"
                                                    target="_blank">{{isset($r['not_visited_forms']) && $r['not_visited_forms']!=''?$r['not_visited_forms']:'0'}}</a>
                                            </td>
                                            <td width="9%"><a
                                                    href="{{route('rs_data_collection_statusdetail').'/c/'.$cluster_no}}"
                                                    target="_blank">{{isset($r['completed_forms']) && $r['completed_forms']!=''?$r['completed_forms']:'0'}}</a>
                                            </td>
                                            <td width="9%"><a
                                                    href="{{route('rs_data_collection_statusdetail').'/not_c/'.$cluster_no}}"
                                                    target="_blank">{{isset($r['not_completed_forms']) && $r['not_completed_forms']!=''?$r['not_completed_forms']:'0'}}</a>
                                            </td>
                                            <td width="9%">
                                                @php
                                                    $status = '';
