...
class Hfa_App_Users extends Controller
{
    ...
    public function index()
    {
        ...
        $data = array();
        $data["districts"] = Hfa_App_Users_Model::getDistricts();
        $data["data"] = Hfa_App_Users_Model::getAllData();
        $data['permission'] = Settings_Model::getUserRights(Auth::user()->idGroup, '', 'hfa_app_users');
        /*==========Log=============*/
        $trackarray = array(
            "activityName" => "Hfa_App_Users",
            "action" => "View Hfa_App_Users -> Function: Hfa_App_Users/index()",
            "PostData" => "",
            "affectedKey" => "",
            "idUser" => Auth::user()->id,
        ...
        if ($data['permission'][0]->CanView == 1) {
            ...
            return view('hfa_rs.hfa_app_users', ['data' => $data]);
        } else {
    ...
    public function addAppUsers(Request $request)
    {
       // echo  1;die;
        ...
        $checkName = Hfa_App_Users_Model::checkName($array['username']);
        if (count($checkName) == 0) {
            if (DB::connection('UeN_HFA_EL')->table('AppUser')->insert($array)) {
        ...
        $trackarray = array(
            "activityName" => "Hfa_App_Users",
            "action" => "Add Hfa_App_Users -> Function: Hfa_App_Users/addAppUsers()",
            "mainResult" => $result[0],
            "result" => $result[1],
            "PostData" => $array,
            "affectedKey" => 'id',
    ...
    {
        $id = $request->input('id');
        $getUserData = Hfa_App_Users_Model::getUserDetails($id);
    ...
    public function editAppUsers(Request $request)
    {
        ...
        if (isset($id) && $id != '') {
            ...
            $updateQuery = DB::connection('UeN_HFA_EL')->table('AppUser')
                ->where('id', $id)
                ->update($array);
            if ($updateQuery) {
        ...
        $trackarray = array(
            "activityName" => "Hfa_App_Users",
            "action" => "Edit Hfa_App_Users -> Function: Hfa_App_Users/editAppUsers()",
            "mainResult" => $result[0],
            "result" => $result[1],
            "PostData" => $array,
            "affectedKey" => 'id=' . $id,
    ...
    public function resetPwd(Request $request)
    {
        ...
        $trackarray = array(
            "activityName" => "Hfa_App_Users",
            "action" => "Edit Hfa_App_Users -> Function: Hfa_App_Users/resetPwd()",
            "mainResult" => $result[0],
            "result" => $result[1],
            "PostData" => $array,
            "affectedKey" => 'id=' . $id,
    ...
    public function deleteAppUsers(Request $request)
    {
        ...
        $trackarray = array(
            "activityName" => "Hfa_App_Users",
            "action" => "Delete Hfa_App_Users -> Function: Hfa_App_Users/deleteAppUsers()",
            "mainResult" => $result[0],
            "result" => $result[1],
            "PostData" => $array,
            "affectedKey" => 'id=' . $id,
